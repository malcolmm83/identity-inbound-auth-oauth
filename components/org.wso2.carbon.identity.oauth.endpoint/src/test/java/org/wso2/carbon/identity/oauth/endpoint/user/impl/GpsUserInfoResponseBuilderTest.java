...
/**
 * Test class to test GpsUserInfoResponseBuilder.
 */
@PrepareForTest({AuthorizationGrantCache.class, JDBCPersistenceManager.class,
        OAuthServerConfiguration.class})
public class GpsUserInfoResponseBuilderTest extends UserInfoResponseBaseTest {

    private GpsUserInfoResponseBuilder gpsUserInfoResponseBuilder;
    Connection con = null;
    ...
    public void setup() throws Exception {
        ...
        gpsUserInfoResponseBuilder = new GpsUserInfoResponseBuilder();
    ...
    public void testSubjectClaim(Map<String, Object> inputClaims,
        ...
        try {
            ...
            gpsUserInfoResponseBuilder = spy(new GpsUserInfoResponseBuilder());
            when(gpsUserInfoResponseBuilder.retrieveUserClaims(any(OAuth2TokenValidationResponseDTO.class)))
            ...
            String responseString =
                    gpsUserInfoResponseBuilder.getResponseString(getTokenResponseDTO(authenticatedUser.toFullQualifiedUsername()));
    ...
    private void testBooleanClaimInUserInfoResponse(String claimUri, String claimValue) throws Exception {
        ...
        mockDataSource();
        String responseString =
                gpsUserInfoResponseBuilder.getResponseString(getTokenResponseDTO(AUTHORIZED_USER_FULL_QUALIFIED));
    ...
    public void testGetResponseString(Map<String, Object> inputClaims,
        ...
        try {
            ...
            mockDataSource();
            String responseString =
                    gpsUserInfoResponseBuilder.getResponseString(
